...
export default function Dashboard() {
  ...
  const menu = [
    ...
    { label: "Journal", icon: <SchoolIcon />, route: "/student/journal" },
    { label: "Chat", icon: <ChatIcon />, route: "/student/chat" },
    { label: "Report", icon: <AssessmentIcon />, route: "/student/report" },
    { label: "Settings", icon: <SettingsIcon />, route: "/student/settings" },
  ];
