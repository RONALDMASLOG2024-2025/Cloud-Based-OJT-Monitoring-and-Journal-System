...
export default function Dashboard() {
  ...
  const menu = [
    ...
    { label: "Journal", icon: <SchoolIcon />, route: "/hte/journal" },
    { label: "Chat", icon: <ChatIcon />, route: "/hte/chat" },
    { label: "Report", icon: <AssessmentIcon />, route: "/hte/report" },
    { label: "Settings", icon: <SettingsIcon />, route: "/hte/settings" },
  ];
          ...
          <Stack direction={"row"} spacing={2} alignItems="center">
            ...
            <div>
              ...
              <Menu
                ...
                anchorEl={anchorEl}
              >
                <MenuItem onClick={() => navigate("/hte/profile")}>
                  <ListItemIcon>
                    <AccountBoxIcon />
                  </ListItemIcon>
